...
var DocumentCloner = exports.DocumentCloner = function () {
    function DocumentCloner(element, options, logger, copyInline, renderer) {
        ...
        copyInline = true; // 修复跨域问题，写死了一些代码 <sfeng sfengme@gmail.com>
        ...
        value: function loadImage(src) {
            ...
            if (isSVG(src)) {
                ...
                if (this.options.allowTaint === true || isInlineBase64Image(src) || this.isSameOrigin(src)) {
                    ...
                    return this.addImage(src, src, true); // 修复跨域问题，干掉了一些代码 <sfeng sfengme@gmail.com>
        ...
        value: function addImage(key, src, useCORS) {
            ...
            var imageLoadHandler = function imageLoadHandler(supportsDataImages) {
                return new Promise(function (resolve, reject) {
                    ...
                    var corsSrc = src; // 修复跨域问题，新增的变量 <sfeng sfengme@gmail.com>
                    if (!supportsDataImages || useCORS) {
                        img.crossOrigin = 'anonymous';
                        if (src.match('?')) {
                            corsSrc = src +"&t="+new Date().getTime();
                        } else {
                            corsSrc = src +"?t="+new Date().getTime();
                        }
                    }
